...
module "benchmark" {
  ...
  server_disks_data_iops       = var.server_disks_data_iops
  server_disks_data_throughput = var.server_disks_data_throughput

  server_disks_wal_size       = var.server_disks_wal_size
  server_disks_wal_iops       = var.server_disks_wal_iops
  server_disks_wal_throughput = var.server_disks_wal_throughput
  ...
  # make_key_vault  = var.make_key_vault # currently not used
