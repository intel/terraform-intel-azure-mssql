...
input.server_disks_wal_size ("512")
Disk size (GiB) for Oracle WAL disk
...
input.server_os_name ("OracleDB19")
Sets which OS will be used for the virtual machines. For now "OracleDB19" is supported.
